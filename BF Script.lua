loadstring(game:HttpGet("https://raw.githubusercontent.com/NBMinhQuan/script-kaitun-bf/refs/heads/main/jointeam.lua"))()

-- local sitink
local sitinklib = loadstring(game:HttpGet("https://raw.githubusercontent.com/NBMinhQuan/script-kaitun-bf/refs/heads/main/Source.lua"))()
local Notify = sitinklib:Notify({
	["Title"] = "MZERO Community",
	["Description"] = "- Blox Fruits Kaitun",
