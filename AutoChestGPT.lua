...
text.Text = "MZERO Community - Auto Collect Chest"
...
local function createBillboardFor(character)
    ...
    local existing = head:FindFirstChild("MZERO_FastAttack_Label")
    if existing then existing:Destroy() end

    local billboard = Instance.new("BillboardGui")
    billboard.Name = "MZERO_FastAttack_Label"
...
local function ShowBlackScreen()
    local gui = Instance.new("ScreenGui")
    gui.Name = "MZERO_Community_HopUI"
    gui.ResetOnSpawn = false
    gui.IgnoreGuiInset = true
    ...
    text1.Text = "MZERO Community - Auto Collect Chest"
